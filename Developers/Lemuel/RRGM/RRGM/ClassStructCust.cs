...
namespace RRGM
{
    class ClassStructCust
    {
        private string cust_ID, store_name, last_name, first_name, middle_initial, address, phone, fax, email, salesman, payment_term, payment_method, bank_account, credit_limit, open_balance, current_balance;
